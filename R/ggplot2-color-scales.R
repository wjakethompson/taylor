...
scale_colour_taylor_d <- function(
  ...,
  alpha = 1,
  begin = 0,
  end = 1,
...
#' @export
#' @rdname scale_taylor
scale_colour_taylor_c <- function(
  ...,
  alpha = 1,
  begin = 0,
  end = 1,
...
#' @export
#' @rdname scale_taylor
scale_colour_taylor_b <- function(
  ...,
  alpha = 1,
  begin = 0,
  end = 1,
