...
In this vignette, we'll describe how access the lyrics for each track and provide some examples for how the lyrics can be used.

## Accessing lyrics in a list-column
...
In the next section, we'll look at some realistic example of using `tidyr::unnest()` and `purrr::map()` to analyze the lyrics data.
