...
Finally, if we have a discrete scale, we can use `ggplot2::scale_fill_manual()` or `ggplot2::scale_color_manual()`. Here, we use the [`penguins`](`?penguins`) to map our palette to the species of penguin.
