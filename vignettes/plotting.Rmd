...
metacritic$album_name <- factor(metacritic$album_name, levels = album_levels)
...
rand_critic$album_name <- factor(
  rand_critic$album_name,
  levels = sample(rand_critic$album_name, size = nrow(rand_critic))
)
...
upper_critic$album_name <- factor(
  upper_critic$album_name,
  levels = album_levels,
