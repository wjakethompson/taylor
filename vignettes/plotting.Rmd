...
Let's create a bar graph showing the rating of each album. We'll first make the album name a factor variable. A convenience variable, `taylor::album_levels`, is included in the package that will let us easily order the factor by album release date. We'll give each bar its own color to add some pizzazz to the plot.
